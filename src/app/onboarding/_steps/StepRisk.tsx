...
const profiles = [
  {
    ...
    label: "محافظ",
    desc: "100% أسهم — عوائد ثابتة وآمنة",
    Icon: Shield,
    returnRange: "4–7%",
    ...
    <div className="flex flex-col justify-center min-h-full px-6 py-10 max-w-lg mx-auto w-full">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm">
          ممكن تغيره في أي وقت من الإعدادات
        </p>
      </motion.div>
            ...
            <motion.button
              ...
              className={cn(
                ...
                isSelected
                  ...
                  : "border-border bg-white/60 hover:border-muted-foreground/40",
              )}
            >
              <div
                className={cn(
                  "w-12 h-12 rounded-2xl flex items-center justify-center shrink-0",
                  isSelected ? p.iconBg : "bg-muted",
                )}
              >
                <p.Icon
                  size={22}
                  className={cn(
                    ...
                    isSelected ? p.iconColor : "text-muted-foreground",
                  )}
                />
              </div>
                ...
                <div className="flex items-center gap-2 mb-0.5">
                  <span
                    className={cn(
                      ...
                      isSelected ? p.selectedText : "text-foreground",
                    )}
                  >
                    {p.label}
                  </span>
                  {p.recommended && (
                    <span className="text-[10px] bg-sukuk-green text-white px-2 py-0.5 rounded-full font-medium">
                      مُوصى به
                    </span>
                  )}
                </div>
              ...
              <div className="shrink-0 text-left">
                <p
                  className={cn(
                    ...
                    isSelected ? p.selectedText : "text-muted-foreground",
                  )}
                >
                  {p.returnRange}
                </p>
      ...
      <motion.button
        ...
        style={
          selected ? { boxShadow: "0 6px 24px oklch(0.48 0.14 152 / 28%)" } : {}
        }
      >
        التالي ←
      </motion.button>
